...
feature_dir = "/mnt/prd/customer_segmentation/imx/aveda/train/features"
model_dir = "/mnt/prd/customer_segmentation/imx/aveda/train/model/"
...
spark.createDataFrame(result_df).write.parquet(os.path.join(model_dir, "result_kmeans_5_cluster_sow_2023_1.parquet"))
    
# save model
joblib.dump(kmeans, os.path.join("/dbfs" + model_dir, "kmeans_model6.pkl"))
