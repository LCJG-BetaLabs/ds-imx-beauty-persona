...
# MAGIC %sql
# MAGIC select distinct item_subcat_desc from transaction
...
# MAGIC (select 
# MAGIC     distinct 
# MAGIC     case when isnull(item_subcat_desc) = 1 or item_subcat_desc = "N/A" then "Unknown" else item_subcat_desc end as item_subcat_desc,
# MAGIC     customer_tag, 
...
# MAGIC select * from
# MAGIC (select 
# MAGIC     distinct case when isnull(item_subcat_desc) = 1 or item_subcat_desc = "N/A" then "Unknown" else item_subcat_desc end as item_subcat_desc,
# MAGIC     customer_tag, 
